...
const DashboardLayout = ({ children, activeMenu }) => {
  ...
  <div className="flex h-screen bg-slate-50">
      ...
      <div
        ...
        } bg-white border-r border-gray-200 rounded-r-2xl shadow-sm`}
      >
        {/* Company Logo */}
        ...
        {/* Logout */}
        {/* Logout - placed in sidebar footer to keep header clean, matching original layout */}
      ...
      >
        {/* Top navbar */}
        <header className="bg-gradient-to-r from-white/60 to-white/40 backdrop-blur-sm border-b border-gray-100 h-20 flex items-center justify-between px-6 sticky top-0 z-30">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 hidden sm:block">
                Your invoices and cashflow at a glance.
              </p>
            </div>
          </div>
